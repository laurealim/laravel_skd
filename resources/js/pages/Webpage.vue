...
const images = slides.map((url, index) => ({ id: index + 1, url: url }));
...
const swiperCaedImages = swiperCaeds.map((s_url, index) => ({ id: index + 1, url: s_url }));
...
<!--                </div>-->
        ...
        <section id="articles" class="bg-white py-12 dark:bg-black">
            <div class="mx-auto max-w-7xl px-4">
                <div class="container m-8 mx-auto max-w-5xl">
                    <!--                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 text-center">Articles</h2>-->
                    <h2
                        class="my-2 w-full text-center text-5xl leading-tight font-bold text-gray-800 max-lg:text-4xl max-md:text-3xl max-sm:text-2xl dark:text-gray-100"
                    >
                        Title
                    </h2>
                ...
                >
                    <SwiperSlide class="w-[100px]" v-for="imgData in swiperCaedImages" :key="imgData.id">
                        <div class="overflow-hidden rounded-lg bg-white shadow-md">
                            <div class="relative">
                                766
                                <img :src="imgData.url" alt="Card image" class="w-full object-cover max-lg:h-40 max-sm:h-32 lg:h-64" />
                                <button class="absolute top-2 right-2 text-xl text-red-500">
                                    <i class="fas fa-heart"></i>
                                </button>
                            </div>
                            <div class="p-4">
                                <h4 class="text-lg font-semibold text-gray-800">Blood Types</h4>
                                <p class="mt-2 text-sm text-gray-600">
                                    Learn about the different blood types and their importance in saving lives. Your knowledge can help us ensure that
                                    patients receive the right blood type when they need it most.
                                </p>
                                <div class="mt-4">
                                    <button
                                        @click="window.location.href = 'article.html'"
        ...
        <section class="border-b bg-white py-8 dark:bg-black">
            <div class="container m-8 mx-auto max-w-5xl">
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 p-6 sm:w-1/2">
                        <h3 class="mb-3 text-3xl leading-none font-bold text-gray-800 max-md:text-2xl dark:text-gray-300">
                            Lorem ipsum dolor sit amet
                        </h3>
                        <p class="mb-8 text-gray-600 dark:text-gray-500">
                    ...
                    <div class="w-full p-6 sm:w-1/2">
                        <svg class="mx-auto w-full sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col-reverse flex-wrap sm:flex-row">
                    <div class="mt-6 w-full p-6 sm:w-1/2">
                        <svg class="mx-auto w-5/6 sm:h-64" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="border-b bg-white py-8 dark:bg-black dark:text-gray-200">
            <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <div class="flex w-full flex-shrink flex-grow flex-col p-6 md:w-1/3">
                    <div class="flex-1 overflow-hidden rounded-t rounded-b-none bg-white shadow dark:bg-neutral-600">
                        <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                            <div class="mt-2 w-full px-6 text-xl font-bold text-gray-800 dark:text-gray-300">Lorem ipsum dolor sit amet.</div>
                            <p class="mb-5 px-6 text-base text-gray-800 dark:text-gray-400">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                            </p>
                        </a>
                    </div>
                    <div class="mt-auto flex-none overflow-hidden rounded-t-none rounded-b bg-white p-6 shadow">
        ...
        <section class="bg-gray-100 py-8 dark:bg-black dark:text-white">
            <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                ...
                <div class="my-12 flex flex-col justify-center pt-12 sm:my-4 sm:flex-row">
                    <div class="mx-auto mt-4 flex w-5/6 flex-col rounded-none bg-white lg:mx-0 lg:w-1/4 lg:rounded-l-lg dark:bg-gray-800">
                        <div
                            class="flex-1 overflow-hidden rounded-t rounded-b-none bg-white text-gray-600 shadow dark:bg-gray-600 dark:text-gray-200"
                        >
                            <div class="w-full p-8 text-center text-3xl font-bold">Free</div>
                            <div class="gradient my-0 h-1 w-full rounded-t from-gray-700 via-gray-900 to-gray-700 py-0 dark:bg-gradient-to-r"></div>
                        ...
                        <div class="mt-auto flex-none overflow-hidden rounded-t-none rounded-b bg-white p-6 shadow dark:bg-gray-400">
                            <div class="w-full pt-6 text-center text-3xl font-bold text-gray-600 dark:text-gray-200">
                                £0
                                <span class="text-base">for one user</span>
                            </div>
                            <div class="flex items-center justify-center">
                                <button
                                    class="gradient focus:shadow-outline mx-auto my-6 transform rounded-full from-gray-200 to-gray-600 px-8 py-4 font-bold text-white shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:underline focus:outline-none lg:mx-0 dark:bg-linear-to-bl"
                                >
                                    Sign Up
                                </button>
                            </div>
                    ...
                    <div class="mx-auto mt-4 flex w-5/6 flex-col rounded-lg bg-white shadow-lg sm:-mt-6 lg:mx-0 lg:w-1/3">
                        <div class="flex-1 overflow-hidden rounded-t rounded-b-none bg-white shadow dark:bg-gray-800 dark:text-gray-200">
                            <div class="w-full p-8 text-center text-3xl font-bold">Basic</div>
                            <div class="gradient my-0 h-1 w-full rounded-t from-gray-500 via-gray-400 to-gray-500 py-0 dark:bg-gradient-to-r"></div>
                        ...
                        <div class="mt-auto flex-none overflow-hidden rounded-t-none rounded-b bg-white p-6 shadow dark:bg-gray-500">
                            <div class="w-full pt-6 text-center text-4xl font-bold dark:text-gray-200">
                                £x.99
                    ...
                    <div class="mx-auto mt-4 flex w-5/6 flex-col rounded-none bg-white lg:mx-0 lg:w-1/4 lg:rounded-l-lg dark:bg-gray-800">
                        <div
                            class="flex-1 overflow-hidden rounded-t rounded-b-none bg-white text-gray-600 shadow dark:bg-gray-600 dark:text-gray-200"
                        >
                            <div class="w-full p-8 text-center text-3xl font-bold">Pro</div>
                            <div class="gradient my-0 h-1 w-full rounded-t from-gray-700 via-gray-900 to-gray-700 py-0 dark:bg-gradient-to-r"></div>
                            <ul class="w-full text-center text-sm">
                                <li class="border-b py-4">Thing</li>
                                <li class="border-b py-4">Thing</li>
