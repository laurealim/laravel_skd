...
<template>
    <div>
        <div class="heroBgs from-gray-800 to-gray-600 pt-13 lg:pt-[4.5rem] dark:bg-gradient-to-tr">
            <div
                class="containers flex w-full flex-col items-center justify-center bg-cover bg-center bg-no-repeat md:flex-row lg:pt-[8.5rem]"
